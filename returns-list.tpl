...
{{capture name="setSerialNumber" assign="setSerialNumber"}}{{$txt['69371::57649_setSerialNumber']}}{{/capture}}
<div class="client_order">
<h1 class="big_label">
<span>{{$txt['69371::54068_linksclosed']}}</span></h1>{{if  $xml->getItem("/shop/page/returns/item")}}
...
<thead>
<tr id="orders_header">
<td class="ord3" id="orders_head_1">{{$txt['69371::51900_001']}}</td>
<td class="ord3" id="orders_head_2">{{$txt['69371::51900_002']}}</td>
<td class="ord3" id="orders_head_3">{{$txt['69371::51900_003']}}</td>
<td class="ord3" id="orders_head_5">{{$txt['69371::51900_005']}}</td>
<td class="ord3" id="orders_head_6">{{$txt['69371::51900_006']}}</td></tr></thead>
<tbody>{{foreach from=$xml->getList("/shop/page/returns/item") item=loop313}}
<tr>
<td class="ord">{{if $setSerialNumber}}{{$loop313->getItemEscape("@number")}}{{else}}{{$loop313->getItemEscape("@id")}}{{/if}}</td>
<td>{{$loop313->getItemEscape("@date")}}</td>
<td class="ord">{{$loop313->getItemEscape("@cost_formatted")}}</td>
<td>{{if  $loop313->getItem("@status_name")  neq (string) ''}}{{$loop313->getItem("@status_name")}}{{elseif  $loop313->getItem("@status") == (string)1}}
                                                                {{$txt['69371::status_1']}}
                                                            {{elseif  $loop313->getItem("@status") == (string)2}}
                                                                {{$txt['69371::status_2']}}
                                                            {{elseif  $loop313->getItem("@status") == (string)3}}
                                                                {{$txt['69371::status_3']}}
                                                            {{elseif  $loop313->getItem("@status") == (string)13}}
                                                                {{$txt['69371::status_13']}}
                                                            {{elseif  $loop313->getItem("@status") == (string)14}}
                                                                {{$txt['69371::status_14']}}
                                                            {{elseif  $loop313->getItem("@status") == (string)15}}
                                                                {{$txt['69371::status_15']}}
                                                            {{elseif  $loop313->getItem("@status") == (string)16}}
                                                                {{$txt['69371::status_16']}}
                                                            {{elseif  $loop313->getItem("@status") == (string)17}}
                                                                {{$txt['69371::status_17']}}
                                                            {{elseif  $loop313->getItem("@status") == (string)18}}
                                                                {{$txt['69371::status_18']}}
                                                            {{/if}}</td>
<td class="ord">
<a class="orders_more" data-tablet-class="btn-small" data-mobile-class="btn-small" href="{{$loop313->getItemEscape("@url")}}">{{$txt['69371::51900_018']}}</a></td></tr>{{/foreach}}</tbody></table>{{else}}
<div class="return_list_noitem menu_messages_message" id="return_list_noitem">{{$txt['69371::return_list_norma']}}</div>{{/if}}</div></div></div>
