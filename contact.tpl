...
{{capture name="contact_mobile_label" assign="contact_mobile_label"}}{{$txt['64866::n62072_contact_label']}}{{/capture}}{{capture name="mapType" assign="mapType"}}{{$txt['64866::64553_MAPA_001']}}{{/capture}}{{capture name="navControl" assign="navControl"}}{{$txt['64866::64553_MAPA_002']}}{{/capture}}{{capture name="mapTypeControl" assign="mapTypeControl"}}{{$txt['64866::64553_MAPA_003']}}{{/capture}}{{capture name="scControl" assign="scControl"}}{{$txt['64866::64553_MAPA_004']}}{{/capture}}{{capture name="controlType" assign="controlType"}}{{$txt['64866::64553_MAPA_005']}}{{/capture}}{{capture name="mapTypeControlStyle" assign="mapTypeControlStyle"}}{{$txt['64866::64553_MAPA_006']}}{{/capture}}{{capture name="markersAnimation" assign="markersAnimation"}}{{$txt['64866::64553_MAPA_007']}}{{/capture}}{{capture name="bCord" assign="bCord"}}{{$txt['64866::64553_MAPA_008']}}{{/capture}}{{capture name="lCord" assign="lCord"}}{{$txt['64866::64553_MAPA_009']}}{{/capture}}{{capture name="mapZoom" assign="mapZoom"}}{{$txt['64866::64553_MAPA_010']}}{{/capture}}{{capture name="mapLanguage" assign="mapLanguage"}}{{$txt['64866::64553_MAPA_011']}}{{/capture}}{{capture name="mapCustomMarkers" assign="mapCustomMarkers"}}{{$txt['64866::64553_MAPA_012']}}{{/capture}}{{capture name="mapHideContact" assign="mapHideContact"}}{{$txt['64866::64553_MAPA_013']}}{{/capture}}
...
<h2 class="big_label">
{{$txt['64866::62072_002']}}</h2>
<div class="contact_contact_sub">
<div class="contact_contact_left">{{if  $xml->getItem("/shop/page/contact/shop_data/@shopname")}}
<h3>{{$xml->getItemEscape("/shop/page/contact/shop_data/@shopname")}}</h3>{{/if}}{{if  $xml->getItem("/shop/page/contact/shop_data/@shopshortname")}}
<p id="contact_contact_shopshortname">{{$xml->getItemEscape("/shop/page/contact/shop_data/@shopshortname")}}</p>{{/if}}{{if  $xml->getItem("/shop/page/contact/shop_data/@street")}}
<p id="contact_contact_street">{{$xml->getItemEscape("/shop/page/contact/shop_data/@street")}}</p>{{/if}}{{if  $xml->getItem("/shop/page/contact/shop_data/@zipcode") or  $xml->getItem("/shop/page/contact/shop_data/@city")}}
<p id="contact_contact_city">{{$xml->getItemEscape("/shop/page/contact/shop_data/@zipcode")}}{{literal}} {{/literal}}{{$xml->getItemEscape("/shop/page/contact/shop_data/@city")}}</p>{{/if}}{{if  $xml->getItem("/shop/page/contact/shop_data/@country")}}
<p id="contact_contact_country">{{$txt['64866::62072_002n']}}{{if  $xml->getItem("/shop/page/contact/shop_data/@province")}}{{$xml->getItemEscape("/shop/page/contact/shop_data/@province")}}{{literal}}, {{/literal}}{{/if}}{{$xml->getItemEscape("/shop/page/contact/shop_data/@country")}}{{$txt['64866::62072_001n']}}</p>{{/if}}{{if  $xml->getItem("/shop/page/contact/shop_data/@street") or  $xml->getItem("/shop/page/contact/shop_data/@street")  neq (string) '' or  $xml->getItem("/shop/page/contact/shop_data/@zipcode") or  $xml->getItem("/shop/page/contact/shop_data/@zipcode")  neq (string) '' or  $xml->getItem("/shop/page/contact/shop_data/@city") or  $xml->getItem("/shop/page/contact/shop_data/@city")  neq (string) ''}}{{if ($mapHideContact  neq (string) '') and  $xml->getItem("/shop/page/contact/google_api_key/@value")}}
...
{{$txt['64866::n62072_a']}}
</a>{{/if}}{{/if}}</div>{{if $contact_mobile_label}}
<h2 class="big_label visible-phone">{{$contact_mobile_label}}</h2>{{/if}}
<div class="contact_contact_right">{{foreach from=$xml->getList("/shop/page/contact/contact_nodes/node") item=loop304}}
<p>{{if  $loop304->getItem("@title") and !( $loop304->getItem("@title")  == (string) '')}}
<strong>{{$loop304->getItemEscape("@title")}}{{$txt['64866::62072_001']}}</strong>{{/if}}{{if  $loop304->getItem("@link")}}
<a href="{{$loop304->getItemEscape("@link")}}">{{if  $loop304->getItem("@gfx")}}
                 class="contact_contact_gfx"
                {{if !( $loop304->getItem("/shop/@sslurl")  neq (string) '')}}
<img src="{{$loop304->getItemEscape("@gfx")}}" alt="{{$loop304->getItemEscape("@value")}}"></img>{{/if}}{{/if}}{{$loop304->getItemEscape("@value")}}</a>{{else}}
<span>{{if  $loop304->getItem("@gfx")}}
                 class="contact_contact_gfx"
                {{if !( $loop304->getItem("/shop/@sslurl")  neq (string) '')}}
<img src="{{$loop304->getItemEscape("@gfx")}}" alt="{{$loop304->getItemEscape("@value")}}"></img>{{/if}}{{/if}}{{$loop304->getItemEscape("@value")}}</span>{{/if}}{{if  $loop304->getItem("@type")  == (string) 'phone'}}
                    {{$txt['64866::62072_phone_ico']}}
                {{elseif  $loop304->getItem("@type")  == (string) 'mail'}}
                    {{$txt['64866::62072_mail_ico']}}
                {{/if}}</p>{{/foreach}}</div>
<div class="clear_all"></div>{{if  $xml->getItem("/shop/page/contact/google_api_key/@value") and ( $xml->getItem("/shop/page/contact/shop_data/@street") or  $xml->getItem("/shop/page/contact/shop_data/@zipcode") or  $xml->getItem("/shop/page/contact/shop_data/@city"))}}
...
<img class="loadingMapImg" src="/gfx/__IAI_TEMPLATE_LANG_639_1__/mapLoader.gif?r=1551959302" alt=""/></div></div></div>
<img class="marker_face" src="/gfx/__IAI_TEMPLATE_LANG_639_1__/marker_face.png?r=1551959302" alt=""/>
<div id="contact_map" class="contact_map_wrapper"></div></div>{{/if}}</div></div>
<!--CMS na stronie Kontaktu (contact_cms, 55199.1)-->
{{if  $xml->getItem("page/contact/text/body")  neq (string) ''}}
<div{{assign "classAttributeTmp5" ""}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}contact_cms{{/capture}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}contact_cms cm{{/capture}}  class="{{$classAttributeTmp5}}">{{$xml->getItem("page/contact/text/body")}}</div>{{/if}}
<!--Dane adresowe na stronie Kontakt (contact_address, 62074.1)-->

<div id="contact_address">
<h2 class="big_label">
{{$txt['62074::62072_002']}}</h2>
<div class="contact_address_sub">
<div class="contact_address_left">
<div class="contact_address_data">{{if  $xml->getItem("/shop/page/contact/owner_data/@firmname")}}
<h3>{{$xml->getItemEscape("/shop/page/contact/owner_data/@firmname")}}</h3>{{/if}}{{if  $xml->getItem("/shop/page/contact/owner_data/@shortfirmname")}}
<p id="contact_address_shopshortname">{{$xml->getItemEscape("/shop/page/contact/owner_data/@shortfirmname")}}</p>{{/if}}{{if  $xml->getItem("/shop/page/contact/owner_data/@street")}}
<p id="contact_address_street">{{$xml->getItemEscape("/shop/page/contact/owner_data/@street")}}</p>{{/if}}{{if  $xml->getItem("/shop/page/contact/owner_data/@zipcode") or  $xml->getItem("/shop/page/contact/owner_data/@city")}}
<p id="contact_address_city">{{$xml->getItemEscape("/shop/page/contact/owner_data/@zipcode")}}{{literal}} {{/literal}}{{$xml->getItemEscape("/shop/page/contact/owner_data/@city")}}</p>{{/if}}{{if  $xml->getItem("/shop/page/contact/owner_data/@country")}}
<p id="contact_address_country">{{$txt['62074::62072_002n']}}{{if  $xml->getItem("/shop/page/contact/owner_data/@province")}}{{$xml->getItemEscape("/shop/page/contact/owner_data/@province")}}{{literal}}, {{/literal}}{{/if}}{{$xml->getItemEscape("/shop/page/contact/owner_data/@country")}}{{$txt['62074::62072_001n']}}</p>{{/if}}</div></div>
<div class="contact_address_right">{{foreach from=$xml->getList("/shop/page/contact/additional_nodes/node") item=loop405}}{{if !( $loop405->getItem("@value")  == (string) '')}}
<p>{{if  $loop405->getItem("@title") and !( $loop405->getItem("@title")  == (string) '')}}
<strong>{{$loop405->getItemEscape("@title")}}{{$txt['62074::62072_001']}}</strong>{{/if}}{{if  $loop405->getItem("@link")}}
<a href="{{$loop405->getItemEscape("@link")}}">{{if  $loop405->getItem("@gfx")}}
								 class="contact_address_gfx"
								{{if !( $loop405->getItem("/shop/@sslurl")  neq (string) '')}}
<img src="{{$loop405->getItemEscape("@gfx")}}" alt="{{$loop405->getItemEscape("@value")}}"></img>{{/if}}{{/if}}{{$loop405->getItemEscape("@value")}}</a>{{else}}
<span>{{if  $loop405->getItem("@gfx")}}
								 class="contact_address_gfx"
								{{if !( $loop405->getItem("/shop/@sslurl")  neq (string) '')}}
<img src="{{$loop405->getItemEscape("@gfx")}}" alt="{{$loop405->getItemEscape("@value")}}"></img>{{/if}}{{/if}}{{$loop405->getItemEscape("@value")}}</span>{{/if}}</p>{{/if}}{{/foreach}}</div></div></div>
<!--Formularz kontaktu na stronie Kontakt (contact_mailform, 61390.1)-->
{{capture name="mobile_button" assign="mobile_button"}}{{$txt['61390::n50201_mobile_button_title']}}{{/capture}}{{if $mobile_button}}
<a class="btn-large btn_arrow visible-phone show-contact-form" href="#show-contact-form" title="{{$mobile_button}}">            
            {{$txt['61390::n50201_mobile_button']}}
        </a>{{/if}}
...
<div{{assign "classAttributeTmp6" ""}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}contact_mailform_sub{{/capture}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}contact_mailform_sub big_label{{/capture}}  class="{{$classAttributeTmp6}}">
            {{$txt['61390::50201_001']}}
            </div></div>
<table class="contact_mailform" align="center" cellspacing="0" cellpadding="0">
<tr>
<td class="contact_mailform1">{{$txt['61390::50201_002']}}</td>
...
<img src="/gfx/__IAI_TEMPLATE_LANG_639_1__/need.gif?r=1551959302" alt="{{$txt['61390::n56203_010b']}}" title="{{$txt['61390::n56203_010b']}}"></img></td></tr>
<tr>
<td class="contact_mailform2">{{$txt['61390::44023_015']}}</td>
<td class="contact_mailform5">
<input type="text" class="contact_mailform_subject" name="subject" size="100" id="subject"/>
<img src="/gfx/__IAI_TEMPLATE_LANG_639_1__/need.gif?r=1551959302" alt="{{$txt['61390::n56203_010b']}}" title="{{$txt['61390::n56203_010b']}}"></img></td></tr>
<tr>
<td class="contact_mailform3">{{$txt['61390::50201_003']}}</td>
...
<div class="contact_legend">
                    {{$txt['61390::n56203_031b']}}
                    
<img src="/gfx/__IAI_TEMPLATE_LANG_639_1__/need.gif?r=1551959302" alt="{{$txt['61390::n56203_010b']}}" title="{{$txt['61390::n56203_010b']}}"></img>{{$txt['61390::n56203_031c']}}
                </div></td></tr></table></form></div></div>
