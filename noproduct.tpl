...
<!--Brak produktów - propozycja produktu (noproduct_product_request_form, 62108.1)-->
...
<span class="noproduct_form_label">
                    {{$txt['62108::noproduct_form_label']}}
                </span></div>
<div class="noproduct_form_sub">
<form id="noproduct_form" method="post" action="{{$xml->getItemEscape("page/action/form/@url")}}">
<input type="hidden" name="add_request_product" value="1"/>
<div class="noproduct_form_desc">
                        {{$txt['62108::noproduct_form_desc']}}
                    </div>
<div class="noproduct_form_section">
<div class="noproduct_form_left1">
<span class="noproduct_form_title">{{$txt['62108::noproduct_form_title1']}}</span></div>
<div class="noproduct_form_right1">
<input type="text" class="noproduct_form_name" name="name" {{if $xml->getItem("page/search_params/text/@value") neq (string) ''}} value=" {{$xml->getItemEscape("page/search_params/text/@value")}} " {{/if}}></input></div></div>
<div class="noproduct_form_section">
<div class="noproduct_form_left2">
<span class="noproduct_form_title">{{$txt['62108::noproduct_form_title2']}}</span></div>
<div class="noproduct_form_right2">
<textarea name="desc" class="noproduct_form_desc"></textarea></div></div>
<div class="noproduct_form_submit">
<a{{assign "classAttributeTmp4" ""}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}noproduct_form_submit{{/capture}} onclick="noproduct_form.checkForm();"{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}btn-small noproduct_form_submit{{/capture}} title="{{$txt['62108::noproduct_form_submit_title']}}"  class="{{$classAttributeTmp4}}">
                            {{$txt['62108::noproduct_form_submit_txt']}}
                        </a></div>
<div class="noproduct_form_desc2">
                        {{$txt['62108::noproduct_form_desc2']}}
                    </div></form></div></div>
<div id="alert_cover" class="projector_alert_55916" style="display:none" onclick="Alertek.hide_alert();">NIE DA SIE</div>{{else}}
<div class="noproduct_form_outline">
<div{{assign "classAttributeTmp3" ""}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}noproduct_form_label{{/capture}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}noproduct_form_label big_label{{/capture}}  class="{{$classAttributeTmp3}}">
<span class="noproduct_form_label">
                    {{$txt['62108::noproduct_form_label']}}
...
<div class="noproduct_form_sub">
<p class="noproduct_form_notlogged">{{$txt['62108::noproduct_form_notlogged']}}</p></div></div>{{/if}}
<!--Brak produktów - cms (noproduct_cms, 58576.1)-->
{{if  $xml->getItem("page/text/body")}}
<div{{assign "classAttributeTmp6" ""}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}noproduct_cms_label{{/capture}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}noproduct_cms_label big_label{{/capture}}  class="{{$classAttributeTmp6}}">
<span class="noproduct_cms_label">
                    {{$txt['58576::noproduct_cms_label']}}
            </span></div>
<div class="noproduct_cms">
<div class="noproduct_cms_sub">{{$xml->getItem("page/text/body")}}</div></div>{{/if}}</div></div>
