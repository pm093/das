...
<!--Lista kategorii (categories, 55814.1)-->
{{if  $xml->getItem("page/categories-list/@mode")  == (string) 2}}
<div class="categories_label">
<span class="categories_label_sub">
<h1{{assign "classAttributeTmp3" ""}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}category_label_link{{/capture}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}category_label_link big_label{{/capture}}  class="{{$classAttributeTmp3}}">
		    	{{$txt['55814::30003_01']}}
			</h1></span></div>
<div class="categories_contener">
<div class="categories_cat">{{foreach from=$xml->getList("navigation2/item") item=loop240}}
<div class="categories_cat_sub">
<a class="categories_cat_link" href="{{$loop240->getItemEscape("@link")}}">{{$loop240->getItem("@name")}}</a>
<span class="n55814_total">
							{{$txt['55814::40002_000']}}
<font class="red">{{$loop240->getItemEscape("@product_quantity")}}</font>{{$txt['55814::40002_001']}}
						</span></div>{{if  $loop240->getItem("item")}}
<div class="categories_sub">{{foreach from=$loop240->getList("item") item=loop254}}{{if (count( $loop254->getList("item"))  gt (string) 0)}}
<div class="each_link">
<a class="categories_3b" href="{{$loop254->getItemEscape("@link")}}">{{$loop254->getItem("@name")}}</a>
<span class="n55814_total">
											{{$txt['55814::40002_002']}}{{$loop254->getItemEscape("@product_quantity")}}{{$txt['55814::40002_003']}}
										</span></div>
<span class="categories_4">{{$loop254->getItemEscape("@id")}}{{foreach from=$loop254->getList("item") item=loop270}}
<div class="each_link">
<a{{assign "hrefAttributeTmp5" ""}}  class=" {{if ( $loop270->getItem("@link")) == (string) ( $loop270->getItem("/shop/navigation2/current/@link"))}}categories_4_active{{else}}categories_4{{/if}} "{{capture name="hrefAttributeTmp5" assign="hrefAttributeTmp5"}}{{$loop270->getItemEscape("@link")}}{{/capture}}{{capture name="hrefAttributeTmp5" assign="hrefAttributeTmp5"}}{{$loop270->getItemEscape("@link")}}{{/capture}}  href="{{$hrefAttributeTmp5}}">{{$loop270->getItem("@name")}}</a>
<span class="n55814_total">
													{{$txt['55814::40002_002']}}{{$loop270->getItemEscape("@product_quantity")}}{{$txt['55814::40002_003']}}
												</span></div>{{/foreach}}</span>{{/if}}{{if (count( $loop254->getList("item"))  == (string) 0)}}
<div class="each_link">
<a class=" {{if ( $loop254->getItem("@link")) == (string) ( $loop254->getItem("/shop/navigation2/current/@link"))}}categories_3_active{{else}}categories_3{{/if}} " href="{{$loop254->getItemEscape("@link")}}">{{$loop254->getItem("@name")}}</a>
<span class="n55814_total">
											{{$txt['55814::40002_002']}}{{$loop254->getItemEscape("@product_quantity")}}{{$txt['55814::40002_003']}}
										</span></div>{{/if}}{{/foreach}}</div>{{/if}}{{/foreach}}</div></div>{{else}}
<div class="categories_label">
<h1{{assign "classAttributeTmp3" ""}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}category_label_link{{/capture}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}category_label_link big_label{{/capture}}  class="{{$classAttributeTmp3}}">
		    	{{$txt['55814::30003_01']}}
			</h1></div>
<div class="categories_contener">
<div class="categories_cat">{{foreach from=$xml->getList("navigation/item") item=loop323}}
<div class="categories_cat_sub">
<a class="categories_cat_link" href="{{$loop323->getItemEscape("@link")}}">{{$loop323->getItem("@name")}}</a>
<span class="n55814_total">
							{{$txt['55814::40002_000']}}
<font class="red">{{$loop323->getItemEscape("@product_quantity")}}</font>{{$txt['55814::40002_001']}}
						</span></div>{{if  $loop323->getItem("item")}}
<div class="categories_sub">{{foreach from=$loop323->getList("item") item=loop337}}{{if (count( $loop337->getList("item"))  gt (string) 0)}}
<div class="each_link">
<a class="categories_3b" href="{{$loop337->getItemEscape("@link")}}">{{$loop337->getItem("@name")}}</a>
<span class="n55814_total">
											{{$txt['55814::40002_002']}}{{$loop337->getItemEscape("@product_quantity")}}{{$txt['55814::40002_003']}}
										</span></div>
<div class="categories_4">{{$loop337->getItemEscape("@id")}}{{foreach from=$loop337->getList("item") item=loop353}}
<div class="each_link">
<a{{assign "hrefAttributeTmp6" ""}}  class=" {{if ( $loop353->getItem("@link")) == (string) ( $loop353->getItem("/shop/navigation2/current/@link"))}}categories_4_active{{else}}categories_4{{/if}} "{{capture name="hrefAttributeTmp6" assign="hrefAttributeTmp6"}}{{$loop353->getItemEscape("@link")}}{{/capture}}{{capture name="hrefAttributeTmp6" assign="hrefAttributeTmp6"}}{{$loop353->getItemEscape("@link")}}{{/capture}}  href="{{$hrefAttributeTmp6}}">{{$loop353->getItem("@name")}}</a>
<span class="n55814_total">
													{{$txt['55814::40002_002']}}{{$loop353->getItemEscape("@product_quantity")}}{{$txt['55814::40002_003']}}
												</span></div>{{/foreach}}</div>{{/if}}{{if (count( $loop337->getList("item"))  == (string) 0)}}
<div class="each_link">
<a class=" {{if ( $loop337->getItem("@link")) == (string) ( $loop337->getItem("/shop/navigation2/current/@link"))}}categories_3_active{{else}}categories_3{{/if}} " href="{{$loop337->getItemEscape("@link")}}">{{$loop337->getItem("@name")}}</a>
<span class="n55814_total">
											{{$txt['55814::40002_002']}}{{$loop337->getItemEscape("@product_quantity")}}{{$txt['55814::40002_003']}}
										</span></div>{{/if}}{{/foreach}}</div>{{/if}}{{/foreach}}</div></div>{{/if}}</div></div>
