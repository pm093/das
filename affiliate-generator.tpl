...
<script type="text/javascript" src="/gfx/{{$xml->getItemEscape("language/@id")}}/affiliate_generator_javascript.js.gzip?r=1551959302"></script></head>{{capture name="meta_body_id" assign="meta_body_id"}}{{$txt['96599::10001_body_id']}}{{/capture}}{{literal}}
...
<span class="affiliate_generator_label_span">
			{{$txt['59947::affiliate_generator_label']}}
		</span></div>
...
<div class="affiliate_generator_type_desc">{{if  $xml->getItem("page/generator[@type='html']")}}
			{{$txt['59947::affiliate_generator_html_text']}}
		{{/if}}{{if  $xml->getItem("page/generator[@type='js']")}}
			{{$txt['59947::affiliate_generator_js_text']}}
		{{/if}}{{if  $xml->getItem("page/generator[@type='php']")}}
			{{$txt['59947::affiliate_generator_php_text']}}
		{{/if}}</div>{{/if}}
<!--Affiliate - generator kodu HTML (affiliate_generator_html, 59940.1)-->
{{if  $xml->getItem("page/generator")}}{{if  $xml->getItem("page/generator[@type='html']")}}
...
<span class="affiliate_generator_html_step1_label_span">
						{{$txt['59940::affiliate_html_step1_label']}}
					</span></div>
<div class="step1_html_desc">
<span>{{$txt['59940::step1_html_descr']}}</span></div>
<div>
<input id="affiliate_link" type="text" value="{{$xml->getItemEscape("/shop/@baseurl")}}"></input></div>
<div class="step1_html_desc2">
<span>{{$txt['59940::step1_html_desc2']}}</span></div>
<div>
<input id="affiliate_link_name" type="text" value="{{$xml->getItemEscape("/shop/contact/owner/@shopname")}}"></input></div>
...
<span class="affiliate_generator_html_step2_label_span">
						{{$txt['59940::affiliate_html_step2_label']}}
					</span></div>
<div class="affiliate_banners">{{if  $xml->getItem("page/generator/banners/banner")}}
<table cellspacing="0" cellpadding="2">{{foreach from=$xml->getList("page/generator/banners/banner") item=loop364}}
<tr>
<td style="vertical-align:middle; padding:5px;">
<input type="hidden" name="height" value="{{$loop364->getItemEscape("@height")}}" id="height_{{$loop364->getItemEscape("@nr")}}"></input>
<input type="hidden" name="width" value="{{$loop364->getItemEscape("@width")}}" id="width_{{$loop364->getItemEscape("@nr")}}"></input>
<input class="affilate_html_banners" type="radio" name="banner"{{if $loop364->getItem("@checked") == (string) 'checked'}} checked=""{{/if}} value="{{$loop364->getItemEscape("@link")}}"></input></td>
<td style="padding:5px;">{{if  $loop364->getItem("@type")  == (string) 'swf'}}
<object{{assign "idAttributeTmp24" ""}}{{capture name="idAttributeTmp24" assign="idAttributeTmp24"}}linkicon{{/capture}} type="application/x-shockwave-flash" data="/{{$loop364->getItemEscape("@link")}}" width="{{$loop364->getItemEscape("@width")}}"{{capture name="idAttributeTmp24" assign="idAttributeTmp24"}}width_{{$loop364->getItemEscape("@nr")}}{{/capture}} height="{{$loop364->getItemEscape("@height")}}"{{capture name="idAttributeTmp24" assign="idAttributeTmp24"}}height_{{$loop364->getItemEscape("@nr")}}{{/capture}}  id="{{$idAttributeTmp24}}">
<param name="movie" value="/{{$loop364->getItemEscape("@link")}}"></param>
<param name="bgcolor" value="#FFFFFF"/>
<param name="WMode" value="Opaque"/></object>{{else}}
<img style="margin:0px;padding:0px" src="/{{$loop364->getItemEscape("@link")}}"></img>{{/if}}</td></tr>{{/foreach}}
<input type="hidden" name="banner" value=" "/></table>{{else}}
<div class="affiliate_no_banners">
                            {{$txt['59940::affiliate_no_banners']}}
                        </div>{{/if}}</div>
...
<span class="affiliate_generator_html_step3_label_span">
						{{$txt['59940::affiliate_html_step3_label']}}
					</span></div>
<div class="affiliate_html_explain">{{$txt['59940::affiliate_html_expl']}}</div>
...
<textarea id="html_output" name="html_output" rows="4" cols="65" readOnly="true"></textarea></div>
<div class="clear"></div></form></div>{{/if}}{{/if}}
<!--Affiliate - generator kodu JavaScript (affiliate_generator_javascript, 65642.1)-->
{{if  $xml->getItem("page/generator")}}{{if  $xml->getItem("page/generator[@type='js']")}}
<div class="affiliate_html_generator">
...
<span class="affiliate_generator_js_step1_label_span">
                                {{$txt['65642::affiliate_js_step1_label']}}
                            </span></div>
<div class="step1_js_desc">
<span>{{$txt['65642::step1_js_desc']}}</span></div>
<div class="affiliate_products_link">
<input type="text" name="link" class="affiliate_products_link" value="{{$xml->getItemEscape("/shop/page/generator/default_link")}}"></input></div>
<div class="affiliate_js_sprawdzenie">
<a{{assign "classAttributeTmp13" ""}}  href="#" id="sprawdzenie_pr"{{capture name="classAttributeTmp13" assign="classAttributeTmp13"}}affiliate_js_sprawdzenie_a{{/capture}}{{capture name="classAttributeTmp13" assign="classAttributeTmp13"}}btn-small affiliate_js_sprawdzenie_a{{/capture}}  class="{{$classAttributeTmp13}}">
                            {{$txt['65642::affiliate_button_4']}}</a>
<img style="display:none;" class="affiliate_loader_gif" id="affiliate_loader_gif" src="/gfx/__IAI_TEMPLATE_LANG_639_1__/affiliate_loader.gif?r=1551959302"/>
<div style="color:green; display:none;" class="affiliate_resources_ok" id="affiliate_resources_ok">
                                {{$txt['65642::affiliate_js_ok']}}
                            </div>
<div style="color:red; display:none;" class="affiliate_resources_none" id="affiliate_resources_none">
                                {{$txt['65642::affiliate_js_none']}}
                            </div></div>
...
<span class="affiliate_generator_js_step2_label_span">
                                {{$txt['65642::affiliate_js_step2_label']}}
                            </span></div>
<div class="affiliate_generator_js_step2_desc">{{$txt['65642::affiliate_js_9_2']}}</div>
<div class="affiliate_wyswietlanie">
<div style="font-weight:bold; font-size:13px;">{{$txt['65642::affiliate_js_10']}}</div>
<table cellspacing="0" cellpadding="0" class="affiliate_wyswietlanie">
<tr>
<td class="affiliate_wyswietlanie_left">{{$txt['65642::affiliate_js_11']}}</td>
<td class="affiliate_wyswietlanie_right">{{if count( $xml->getList("/shop/language/option"))  == (string) 1}}{{foreach from=$xml->getList("/shop/language/option") item=loop479}}{{$loop479->getItemEscape("@name")}}
<input type="hidden" id="lang" name="language" value="{{$loop479->getItemEscape("@id")}}"></input>{{/foreach}}{{else}}
<select class="affiliate_wyglad" id="lang" name="language">{{foreach from=$xml->getList("/shop/language/option") item=loop486}}
<option value="{{$loop486->getItemEscape("@id")}}">{{$loop486->getItemEscape("@name")}}</option>{{/foreach}}</select>{{/if}}</td></tr>
<tr>
<td class="affiliate_wyswietlanie_left">{{$txt['65642::affiliate_js_12']}}</td>
<td class="affiliate_wyswietlanie_right">{{if count( $xml->getList("/shop/currency/option"))  == (string) 1}}{{foreach from=$xml->getList("/shop/currency/option") item=loop499}}{{$loop499->getItemEscape("@id")}} ({{$loop499->getItemEscape("@symbol")}})
<input type="hidden" id="curr" name="currency" value="{{$loop499->getItemEscape("@id")}}"></input>{{/foreach}}{{else}}
<select class="affiliate_wyglad" id="curr" name="currency">{{foreach from=$xml->getList("/shop/currency/option") item=loop506}}
<option value="{{$loop506->getItemEscape("@id")}}">{{$loop506->getItemEscape("@id")}} ({{$loop506->getItemEscape("@symbol")}})</option>{{/foreach}}</select>{{/if}}</td></tr>
<tr id="affiliate_ilosc_produktow">
<td class="affiliate_wyswietlanie_left">{{$txt['65642::affiliate_js_112']}}</td>
...
<td class="affiliate_wyswietlanie_left">{{$txt['65642::affiliate_js_112_2']}}</td>
<td class="affiliate_wyswietlanie_right">
<select class="affiliate_wyglad" id="products_uklad" name="products_uklad">
<option value="poziomy">{{$txt['65642::affiliate_js_pionowy']}}</option>
<option value="pionowy">{{$txt['65642::affiliate_js_poziomy']}}</option></select></td></tr>
<tr>
<td class="affiliate_wyswietlanie_left">{{$txt['65642::affiliate_js_112_55']}}</td>
<td class="affiliate_wyswietlanie_right">
<input value="225" style="width:40px;" type="text" name="banner_width" id="banner_width"/> px
                                    </td></tr>
<tr>
<td class="affiliate_wyswietlanie_left">{{$txt['65642::affiliate_js_112_66']}}</td>
<td class="affiliate_wyswietlanie_right">
<input value="300" style="width:40px;" type="text" name="banner_height" id="banner_height"/> px
                                    </td></tr>
<tr>
<td class="affiliate_wyswietlanie_left">{{$txt['65642::affiliate_js_112_77']}}</td>
<td class="affiliate_wyswietlanie_right">
<input value="225" style="width:40px;" type="text" name="image_width" id="image_width"/> px
                                    </td></tr>
<tr>
<td class="affiliate_wyswietlanie_left">{{$txt['65642::affiliate_js_112_88']}}</td>
<td class="affiliate_wyswietlanie_right">
<input value="220" style="width:40px;" type="text" name="image_height" id="image_height"/> px
                                    </td></tr></table>
<input type="hidden" name="affiliate" value="{{$xml->getItemEscape("basket/@login")}}"></input></div>
<div class="affiliate_kolorystyka">
<div style="font-weight:bold; font-size:13px;">{{$txt['65642::affiliate_js_13']}}</div>
<table class="affiliate_kolorystyka">
<tr>
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65642::affiliate_js_14']}}</span></td>
...
<tr>
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65642::affiliate_js_16']}}</span></td>
<td class="affiliate_kolorystyka_right">
...
<tr>
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65642::affiliate_js_16_3']}}</span></td>
<td class="affiliate_kolorystyka_right">
...
<tr>
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65642::affiliate_js_17']}}</span></td>
<td class="affiliate_kolorystyka_right">
<span>
...
<input name="border_radio" class="border_color" type="radio" id="border_radio2" value="tak">{{$txt['65642::affiliate_js_19']}}</input></span></td></tr>
<tr id="border_tr" style="display:none;">
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65642::affiliate_js_20']}}</span></td>
<td class="affiliate_kolorystyka_right">
<div>
...
<tr>
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65642::affiliate_js_21']}}</span></td>
<td class="affiliate_kolorystyka_right">
<span>
...
<span style="margin-left:10px;">
<input name="background_radio" class="background_color" type="radio" id="background_radio2" value="tak">{{$txt['65642::affiliate_js_23']}}</input></span></td></tr>
<tr id="background_tr" style="display:none;">
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65642::affiliate_js_24']}}</span></td>
<td class="affiliate_kolorystyka_right">
<div>
...
<div class="clear"></div>
<div class="affiliate_podglad_desc">{{$txt['65642::affiliate_js_24_1']}}</div>
<a{{assign "classAttributeTmp15" ""}}  href="#" id="podglad_button"{{capture name="classAttributeTmp15" assign="classAttributeTmp15"}}affiliate_podglad_button{{/capture}}{{capture name="classAttributeTmp15" assign="classAttributeTmp15"}}btn-small affiliate_podglad_button{{/capture}}  class="{{$classAttributeTmp15}}">
                            {{$txt['65642::affiliate_button_5']}}</a>
...
<span class="affiliate_generator_js_step3_label_span">
                                {{$txt['65642::affiliate_js_step3_label']}}
                            </span></div>
<div class="affiliate_js_step3_desc">{{$txt['65642::affiliate_js_25']}}</div>
<div class="js_generator_output" id="js_generator_output">
<textarea class="js_output" readonly="true" cols="65" rows="4" name="output" id="output"></textarea></div>
<a{{assign "classAttributeTmp17" ""}}  id="affiliate_js_generate"{{capture name="classAttributeTmp17" assign="classAttributeTmp17"}}affiliate_js_generate{{/capture}} href="#"{{capture name="classAttributeTmp17" assign="classAttributeTmp17"}}btn-small affiliate_js_generate{{/capture}}  class="{{$classAttributeTmp17}}">
                            {{$txt['65642::affiliate_button_6']}}</a></form></div>{{/if}}{{/if}}
<!--Affiliate - generator kodu PHP (affiliate_generator_php, 65643.1)-->
{{if  $xml->getItem("page/generator")}}{{if  $xml->getItem("page/generator[@type='php']")}}
<div id="php_code" style="display:none;">{{foreach from=$xml->getList("page/generator/code/line") item=loop631}}{{$loop631->getItemEscape("text")}}
<br/>{{/foreach}}</div>
<div class="affiliate_html_generator">
...
<div{{assign "classAttributeTmp12" ""}}{{capture name="classAttributeTmp12" assign="classAttributeTmp12"}}affiliate_generator_js_step1_label{{/capture}}{{capture name="classAttributeTmp12" assign="classAttributeTmp12"}}big_label affiliate_generator_js_step1_label{{/capture}}  class="{{$classAttributeTmp12}}">
<span class="affiliate_generator_js_step1_label_span">
                        {{$txt['65643::affiliate_js_step1_label']}}
                    </span></div>
<div class="step1_js_desc">
<span>{{$txt['65643::step1_js_desc']}}</span></div>
<div class="affiliate_products_link">
<input type="text" name="link" class="affiliate_products_link" value="{{$xml->getItemEscape("/shop/page/generator/default_link")}}"></input></div>
<div class="affiliate_js_sprawdzenie">
<a{{assign "classAttributeTmp13" ""}}  href="#" id="sprawdzenie_pr"{{capture name="classAttributeTmp13" assign="classAttributeTmp13"}}affiliate_js_sprawdzenie_a{{/capture}}{{capture name="classAttributeTmp13" assign="classAttributeTmp13"}}btn-small affiliate_js_sprawdzenie_a{{/capture}}  class="{{$classAttributeTmp13}}"> 
{{$txt['65643::affiliate_button_8']}}</a>
<img style="display:none;" class="affiliate_loader_gif" id="affiliate_loader_gif" src="/gfx/__IAI_TEMPLATE_LANG_639_1__/affiliate_loader.gif?r=1551959302"/>
<div style="color:green; display:none;" class="affiliate_resources_ok" id="affiliate_resources_ok">
                        {{$txt['65643::affiliate_js_ok']}}
                    </div>
<div style="color:red; display:none;" class="affiliate_resources_none" id="affiliate_resources_none">
                        {{$txt['65643::affiliate_js_none']}}
                    </div></div>
<div{{assign "classAttributeTmp14" ""}}{{capture name="classAttributeTmp14" assign="classAttributeTmp14"}}affiliate_generator_js_step2_label{{/capture}}{{capture name="classAttributeTmp14" assign="classAttributeTmp14"}}big_label affiliate_generator_js_step2_label{{/capture}}  class="{{$classAttributeTmp14}}">
<span class="affiliate_generator_js_step2_label_span">
                        {{$txt['65643::affiliate_js_step2_label']}}
                    </span></div>
<div class="affiliate_generator_js_step2_desc">{{$txt['65643::affiliate_js_9_2']}}</div>
<div class="affiliate_wyswietlanie">
<div style="font-weight:bold; font-size:13px;">{{$txt['65643::affiliate_js_10']}}</div>
<table cellspacing="0" cellpadding="0" class="affiliate_wyswietlanie">
<tr>
<td class="affiliate_wyswietlanie_left">{{$txt['65643::affiliate_js_11']}}</td>
<td class="affiliate_wyswietlanie_right">{{if count( $xml->getList("/shop/language/option"))  == (string) 1}}{{foreach from=$xml->getList("/shop/language/option") item=loop685}}{{$loop685->getItemEscape("@name")}}
<input type="hidden" id="lang" name="language" value="{{$loop685->getItemEscape("@id")}}"></input>{{/foreach}}{{else}}
<select class="affiliate_wyglad" id="lang" name="language">{{foreach from=$xml->getList("/shop/language/option") item=loop692}}
<option value="{{$loop692->getItemEscape("@id")}}">{{$loop692->getItemEscape("@name")}}</option>{{/foreach}}</select>{{/if}}</td></tr>
<tr>
<td class="affiliate_wyswietlanie_left">{{$txt['65643::affiliate_js_12']}}</td>
<td class="affiliate_wyswietlanie_right">{{if count( $xml->getList("/shop/currency/option"))  == (string) 1}}{{foreach from=$xml->getList("/shop/currency/option") item=loop705}}{{$loop705->getItemEscape("@id")}} ({{$loop705->getItemEscape("@symbol")}})
<input type="hidden" id="curr" name="currency" value="{{$loop705->getItemEscape("@id")}}"></input>{{/foreach}}{{else}}
<select class="affiliate_wyglad" id="curr" name="currency">{{foreach from=$xml->getList("/shop/currency/option") item=loop712}}
<option value="{{$loop712->getItemEscape("@id")}}">{{$loop712->getItemEscape("@id")}} ({{$loop712->getItemEscape("@symbol")}})</option>{{/foreach}}</select>{{/if}}</td></tr>
<tr id="affiliate_ilosc_produktow">
<td class="affiliate_wyswietlanie_left">{{$txt['65643::affiliate_js_112']}}</td>
<td class="affiliate_wyswietlanie_right">
<select class="affiliate_wyglad" id="products_count" name="products_count">
<option value="1">1</option>
<option selected="selected" value="2">2</option>
...
<option value="4">4</option></select></td></tr>
<tr id="affiliate_uklad_produktow">
<td class="affiliate_wyswietlanie_left">{{$txt['65643::affiliate_js_112_2']}}</td>
<td class="affiliate_wyswietlanie_right">
<select class="affiliate_wyglad" id="products_uklad" name="products_uklad">
<option value="poziomy">{{$txt['65643::affiliate_js_pionowy']}}</option>
<option value="pionowy">{{$txt['65643::affiliate_js_poziomy']}}</option></select></td></tr>
<tr>
<td class="affiliate_wyswietlanie_left">{{$txt['65643::affiliate_php_112_55']}}</td>
<td class="affiliate_wyswietlanie_right">
<input value="225" style="width:40px;" type="text" name="banner_width" id="banner_width"/> px
                            </td></tr>
<tr>
<td class="affiliate_wyswietlanie_left">{{$txt['65643::affiliate_php_112_66']}}</td>
<td class="affiliate_wyswietlanie_right">
<input value="100" style="width:40px;" type="text" name="banner_height" id="banner_height"/> px
                            </td></tr></table>
<input type="hidden" name="affiliate" value="{{$xml->getItemEscape("basket/@login")}}"></input></div>
<div class="affiliate_kolorystyka">
<div style="font-weight:bold; font-size:13px;">{{$txt['65643::affiliate_js_13']}}</div>
<table class="affiliate_kolorystyka">
<tr>
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65643::affiliate_js_14']}}</span></td>
<td class="affiliate_kolorystyka_right">
<input name="color3" type="text" style="width: 60px;" maxlength="7" value="#000000" id="color3" class="iColorPicker"/>
<span style="float:left;">
...
<tr>
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65643::affiliate_js_16']}}</span></td>
<td class="affiliate_kolorystyka_right">
<input name="color4" class="iColorPicker" type="text" style="width: 60px;" maxlength="7" value="#d9592b" id="color4"/>
<span style="float:left;">
...
<tr>
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65643::affiliate_js_16_3']}}</span></td>
<td class="affiliate_kolorystyka_right">
<input name="color5" class="iColorPicker" type="text" style="width: 60px;" maxlength="7" value="#8d8d8d" id="color5"/>
<span style="float:left;">
...
<tr>
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65643::affiliate_js_17']}}</span></td>
<td class="affiliate_kolorystyka_right">
<span>
...
<span style="margin-left:10px;">
<input name="border_radio" class="border_color" type="radio" id="border_radio2" value="tak">{{$txt['65643::affiliate_js_19']}}</input></span></td></tr>
<tr id="border_tr" style="display:none;">
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65643::affiliate_js_20']}}</span></td>
<td class="affiliate_kolorystyka_right">
<div>
<input name="color1" class="iColorPicker" type="text" style="width: 60px;" maxlength="7" value="#fff" id="color1"/>
...
<tr>
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65643::affiliate_js_21']}}</span></td>
<td class="affiliate_kolorystyka_right">
<span>
...
<span style="margin-left:10px;">
<input name="background_radio" class="background_color" type="radio" id="background_radio2" value="tak">{{$txt['65643::affiliate_js_23']}}</input></span></td></tr>
<tr id="background_tr" style="display:none;">
<td class="affiliate_kolorystyka_left">
<span>{{$txt['65643::affiliate_js_24']}}</span></td>
<td class="affiliate_kolorystyka_right">
<div>
<input name="color2" class="iColorPicker" type="text" style="width: 60px;" maxlength="7" value="#fff" id="color2"/>
<div class="clear"></div></div></td></tr></table></div>
<div class="clear"></div>
<div class="affiliate_podglad_desc">{{$txt['65643::affiliate_js_24_1']}}</div>
<a{{assign "classAttributeTmp15" ""}}  href="#" id="podglad_button"{{capture name="classAttributeTmp15" assign="classAttributeTmp15"}}affiliate_podglad_button{{/capture}}{{capture name="classAttributeTmp15" assign="classAttributeTmp15"}}btn-small affiliate_podglad_button{{/capture}}  class="{{$classAttributeTmp15}}"> 
{{$txt['65643::affiliate_button_9']}}</a>
<div class="podglad"></div>
<div{{assign "classAttributeTmp16" ""}}{{capture name="classAttributeTmp16" assign="classAttributeTmp16"}}affiliate_generator_js_step3_label{{/capture}}{{capture name="classAttributeTmp16" assign="classAttributeTmp16"}}big_label affiliate_generator_js_step3_label{{/capture}}  class="{{$classAttributeTmp16}}">
<span class="affiliate_generator_js_step3_label_span">
                        {{$txt['65643::affiliate_js_step3_label']}}
                    </span></div>
...
<ul class="php_ul">
<li>{{$txt['65643::affiliate_php_3']}}</li>
<li>{{$txt['65643::affiliate_php_4']}}</li></ul>
...
<li>ISO-8859-1</li>
<li>ISO-8859-2</li>
<li>ISO-8859-3 ... ISO-8859-15</li></ul>
<p class="affiliate_php_desc">{{$txt['65643::affiliate_php_6']}}
                    
<a href="http://php.net/">http://php.net/</a></p></div>
<a{{assign "classAttributeTmp23" ""}}  id="affiliate_php_generate"{{capture name="classAttributeTmp23" assign="classAttributeTmp23"}}affiliate_php_generate{{/capture}} href="#"{{capture name="classAttributeTmp23" assign="classAttributeTmp23"}}btn-small affiliate_php_generate{{/capture}}  class="{{$classAttributeTmp23}}">
{{$txt['65643::affiliate_button_7']}}</a>
<div style="display:none;" class="php_generator_output" id="php_output"></div></form></div>{{/if}}{{/if}}</div></div>
