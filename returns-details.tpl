...
{{if  $xml->getItem("page[@display='details']")}}{{capture name="prepaid016txt" assign="prepaid016txt"}}{{$txt['69381::prepaid016']}}{{/capture}}{{capture name="prepaid017atxt" assign="prepaid017atxt"}}{{$txt['69381::prepaid017a']}}{{/capture}}{{capture name="prepaid017txt" assign="prepaid017txt"}}{{$txt['69381::prepaid017']}}{{/capture}}{{capture name="n5_4atxt" assign="n5_4atxt"}}{{$txt['69381::5_4a']}}{{/capture}}
<div class="step7">
<div id="orderdetails_info">
<h2 class="big_label">
<span>{{$txt['69381::prepaid0011']}}</span>
<span class="order-date">
                            {{$txt['69381::prepaid007']}}{{$xml->getItemEscape("page/details/@datetime")}}</span></h2>
...
<strong>{{if  $xml->getItem("page/details/@status_name")  neq (string) ''}}{{$xml->getItem("page/details/@status_name")}}{{elseif  $xml->getItem("page/details/@status") == (string)1}}
                                    ...
                                    {{elseif  $xml->getItem("page/details/@status") == (string)18}}
                                        {{$txt['69381::status_18']}}
                                    {{/if}}</strong>
<small>{{$txt['69381::prepaid006']}}{{$xml->getItemEscape("page/details/@id")}}</small></div>
<div class="prepaid-buttons">{{if  $xml->getItem("/shop/page/editlink/@url")}}
<a class="btn-icon prepaid-edit" title="{{$txt['69381::prepaid172edit']}}" href="{{$xml->getItemEscape("/shop/page/editlink/@url")}}">{{$txt['69381::prepaid064edit']}}</a>{{/if}}{{if  $xml->getItem("/shop/page/cancellink/@url")}}
<a class="btn-icon prepaid-cancel orderdetails_info_cancel" onclick="return confirm('{{$txt['69381::prepaid170']}}')" title="{{$txt['69381::prepaid171']}}" href="{{$xml->getItemEscape("/shop/page/cancellink/@url")}}">
                                    {{$txt['69381::prepaid063']}}
                                </a>{{/if}}</div></div></div>{{if  $xml->getItem("/shop/page/return_method/@id") == (string)'2' and $n5_4atxt}}
<div class="return_image_i">
<div class="text-1a">{{$txt['69381::5_1a']}}</div>
<div class="text-2a">{{$txt['69381::5_2a']}}</div>
<div class="text-3a">{{$txt['69381::5_4a']}}</div>
<img src="/gfx/__IAI_TEMPLATE_LANG_639_1__/instukcja_zwrot2.png?r=1551959302" alt=""/></div>{{else}}
<div class="return_image_i">
<div class="text-1">{{$txt['69381::5_1']}}</div>
<div class="text-2">{{$txt['69381::5_2']}}</div>
<div class="text-3">{{$txt['69381::5_3']}}</div>
<div class="text-4">{{$txt['69381::5_4']}}</div>
<img src="/gfx/__IAI_TEMPLATE_LANG_639_1__/instukcja_zwrot.png?r=1551959302" alt=""/></div>{{/if}}{{if  $xml->getItem("/shop/page/documentlink/@url")}}
<div class="return_wrapper2">
<a class="btn-large" target="blank" href="{{$xml->getItemEscape("/shop/page/documentlink/@url")}}">
                            {{$txt['69381::50001_10wya']}}
                        </a></div>{{/if}}{{if  $xml->getItem("page/returnproducts/products/product")}}{{capture name="setIconLarge" assign="setIconLarge"}}{{$txt['69381::57664_setIconLarge']}}{{/capture}}
<div id="prepaid_order_products">
<h2 class="big_label">{{$txt['69381::53790_001b']}}</h2>
<table class="ui-responsive table-stroke ui-table ui-table-reflow orders">
<thead>
<tr>
<th/>
<th/>{{if !( $xml->getItem("page/returnproducts/products/product/size/@type")  == (string) 'uniw')}}
<th>{{$txt['69381::50001_004']}}</th>{{/if}}{{if !( $xml->getItem("page/returnproducts/products/product/@code")  == (string) '')}}
<th>
                                            {{$txt['69381::50001_99']}}
                                        </th>{{/if}}
<th>
                                        {{$txt['69381::n56465_099b']}}
                                    </th>
<th>
                                        {{$txt['69381::n56465_099_pkt']}}
                                    </th></tr></thead>
<tbody>{{foreach from=$xml->getList("page/returnproducts/products/product") item=loop430}}
<tr>
<td class="ordered-icon">{{if  $loop430->getItem("@link")}}
<a href="{{$loop430->getItemEscape("@link")}}">{{if $setIconLarge}}
<img src="{{$loop430->getItemEscape("icon")}}" alt="{{$loop430->getItemEscape("@name")}}"></img>{{else}}
<img src="{{$loop430->getItemEscape("iconsmall")}}" alt="{{$loop430->getItemEscape("@name")}}"></img>{{/if}}</a>{{else}}{{if $setIconLarge}}
<img src="{{$loop430->getItemEscape("icon")}}" alt="{{$loop430->getItemEscape("@name")}}"></img>{{else}}
<img src="{{$loop430->getItemEscape("iconsmall")}}" alt="{{$loop430->getItemEscape("@name")}}"></img>{{/if}}{{/if}}</td>
<td class="ordered-name">{{if  $loop430->getItem("@link")}}
<a href="{{$loop430->getItemEscape("@link")}}" title="{{$loop430->getItemEscape("@name")}}">{{$loop430->getItemEscape("@name")}}</a>{{else}}
<span>{{$loop430->getItemEscape("@name")}}</span>{{/if}}{{if  $loop430->getItem("@product_type")  == (string) 'product_bundle'}}
<div class="ordered-product_bundle">
<label>
                                                        {{$txt['69381::50001_z001']}}
                                                    </label>
<ul>{{foreach from=$loop430->getList("bundled/product") item=loop482}}
<li>{{$loop482->getItemEscape("@name")}}{{if !( $loop482->getItem("@size_id")  == (string) 'uniw') or (( $loop482->getItem("version")) and (!( $loop482->getItem("version/@product_name") == (string)'')))}}
                                                                    {{$txt['69381::50001_z002']}}
                                                                    {{if !( $loop482->getItem("@size_id")  == (string) 'uniw')}}
                                                                        {{$txt['69381::50001_004']}}: 
<b>{{$loop482->getItemEscape("@size_desc")}}</b>{{/if}}{{if !( $loop482->getItem("@size_id")  == (string) 'uniw') and (( $loop482->getItem("version")) and (!( $loop482->getItem("version/@product_name") == (string)'')))}}
                                                                        {{$txt['69381::50001_z003']}}
                                                                    {{/if}}{{if ( $loop482->getItem("version")) and (!( $loop482->getItem("version/@product_name") == (string)''))}}{{$loop482->getItemEscape("version/@name")}}
                                                                        : 
<b>{{$loop482->getItemEscape("version/@product_name")}}</b>{{/if}}
                                                                    {{$txt['69381::50001_z004']}}
                                                                {{/if}}</li>{{/foreach}}</ul></div>{{/if}}{{if  $loop430->getItem("order_files/file")}}
<div class="ordered-files">
<label>
                                                        {{$txt['69381::51000_f_01']}}
                                                    </label>
<ul>{{foreach from=$loop430->getList("order_files/file") item=loop510}}
<li>
<span>{{$loop510->getItemEscape("@file")}}</span>{{if  $loop510->getItem("@path")}}
                                                                    {{$txt['69381::order2_change_delivery_left']}}
                                                                    
<a href="{{$loop510->getItemEscape("@path")}}" {{if $loop510->getItem("@preview") == (string) 'true'}} data-imagelightbox="f" {{else}} target="_blank" {{/if}}>
                                                                        {{$txt['69381::51000_f_02']}}
                                                                    </a>
                                                                    {{$txt['69381::order2_change_delivery_right']}}
                                                                {{/if}}</li>{{/foreach}}</ul></div>{{/if}}{{if  $loop430->getItem("@product_type")  == (string) 'product_virtual'}}
<div class="ordered-info">
                                                    {{$txt['69381::67199_onlyvirtual_1']}}
                                                    
<a href="{{$loop430->getItemEscape("/shop/client_files/@link_to_download")}}">
                                                        {{$txt['69381::67199_onlyvirtual_link2']}}
                                                    </a>
                                                    {{$txt['69381::67199_onlyvirtual_2']}}
                                                </div>{{/if}}</td>{{if !( $loop430->getItem("/shop/page/returnproducts/products/product/size/@type")  == (string) 'uniw')}}
<td class="ordered-size">{{$loop430->getItemEscape("@size_desc")}}</td>{{/if}}{{if !( $loop430->getItem("/shop/page/returnproducts/products/product/@code")  == (string) '')}}
<td class="ordered-code">{{$loop430->getItemEscape("@code")}}</td>{{/if}}
<td class="ordered-quantity">{{$loop430->getItemEscape("@quantity")}}{{literal}} {{/literal}}{{if  $loop430->getItem("@quantity")  gt (string) '1'}}{{$loop430->getItemEscape("@unit")}}{{else}}{{$loop430->getItemEscape("@unit_s")}}{{/if}}</td>
<td class="ordered-price">{{if  $loop430->getItem("@quantity")  gt (string) '1'}}{{if  $loop430->getItem("@forpoints") == (string)'true'}}{{$loop430->getItemEscape("@points_sum")}}
                                                            {{$txt['69381::53790_901']}}
                                                        {{else}}{{$loop430->getItemEscape("@bruttoworth_formatted")}}{{/if}}{{else}}{{if  $loop430->getItem("@gratis") == (string)'y'}}
                                                            {{$txt['69381::53790_901g']}}
                                                        {{elseif  $loop430->getItem("@forpoints") == (string)'true'}}{{$loop430->getItemEscape("@points")}}
                                                            {{$txt['69381::53790_901']}}
                                                        {{else}}{{$loop430->getItemEscape("@detalprice_formatted")}}{{/if}}{{/if}}</td></tr>{{if  $loop430->getItem("remarks")}}
<tr>
<td/>
<td colspan="5" class="rma-remarks">
<div class="rma-remarks">
<b class="rma-remarks">{{$txt['69381::51000_022comment']}}</b>{{$loop430->getItemEscape("remarks")}}</div></td></tr>{{/if}}{{/foreach}}</tbody></table></div>{{/if}}{{if  $xml->getItem("/shop/page/repayment_method") or  $xml->getItem("/shop/page/return_method")}}
<div class="returns_details_wrapper">
<table class="returns_details_table">
<tbody>
<tr>
<th class="returns_details_name">{{$txt['69381::00_004']}}
                                    </th></tr>{{if  $xml->getItem("/shop/page/return_method")}}
<tr>
<td class="returns_details_name float_icon">
<img class="return_detials_shipment_icon" src=" {{$xml->getItemEscape("/shop/page/return_method/@icon")}} " alt=" {{$xml->getItemEscape("/shop/page/return_method/@name")}} "></img>{{if  $xml->getItem("/shop/page/return_method/@id")  == (string) 1}}
<span class="product_name">
                                                        {{$txt['69381::order2_info_21a']}}
                                                        {{$txt['69381::51900_1_bis']}}
                                                    </span>
<div class="return_description">
                                                        {{$txt['69381::51900_1_d_bis']}}
                                                    </div>{{elseif  $xml->getItem("/shop/page/return_method/@id")  == (string) 2}}
<span class="product_name">
                                                        {{$txt['69381::order2_info_21a']}}
                                                        {{$txt['69381::51900_2_bis']}}
                                                    </span>
<div class="return_description">
                                                        {{$txt['69381::51900_2_d_bis']}}
                                                    </div>{{elseif  $xml->getItem("/shop/page/return_method/@id")  == (string) 3}}
<span class="product_name">
                                                        {{$txt['69381::order2_info_21a']}}
                                                        {{$txt['69381::51900_3_bis']}}
                                                    </span>
<div class="return_description">
                                                        {{$txt['69381::51900_3_d_bis']}}
                                                    </div>{{elseif  $xml->getItem("/shop/page/return_method/@description")}}
<span class="product_name">{{$txt['69381::order2_info_21a']}}
                                                        {{$xml->getItemEscape("/shop/page/return_method/@name")}}</span>
<div class="return_description">{{$xml->getItemEscape("/shop/page/return_method/@description")}}</div>{{/if}}{{if $prepaid016txt and ( $xml->getItem("/shop/page/trackinglink/@url") or  $xml->getItem("/shop/page/trackinglink/@dispatchid"))}}
<ul>
<li>
<strong>{{$prepaid016txt}}</strong>{{$xml->getItemEscape("/shop/page/trackinglink/@dispatchid")}}</li>{{if  $xml->getItem("/shop/page/trackinglink/@url")}}
<li>
<strong>{{$prepaid017atxt}}</strong>
<a target="_blank" href="{{$xml->getItemEscape("/shop/page/trackinglink/@url")}}">{{$prepaid017txt}}</a></li>{{/if}}</ul>{{/if}}</td></tr>{{/if}}{{if  $xml->getItem("/shop/page/repayment_method")}}
<tr>
<td class="returns_details_name float_icon">
<img class="return_detials_shipment_icon" src=" {{$xml->getItemEscape("/shop/page/repayment_method/@icon")}} " alt=" {{$xml->getItemEscape("/shop/page/repayment_method/@name")}} "></img>{{if  $xml->getItem("/shop/page/repayment_method/@id")  == (string) 't'}}
<span class="product_name">{{$txt['69381::51900_1']}}</span>
<div class="return_description">
                                                        {{$txt['69381::51900_1_d']}}
                                                    </div>{{elseif  $xml->getItem("/shop/page/repayment_method/@id")  == (string) 'b'}}
<span class="product_name">{{$txt['69381::51900_2']}}</span>
<div class="return_description">
                                                        {{$txt['69381::51900_2_d']}}
                                                    </div>{{elseif  $xml->getItem("/shop/page/repayment_method/@id")  == (string) 'tc'}}
...
<div class="return_description">{{$xml->getItemEscape("/shop/page/repayment_method/@description")}}</div>{{/if}}</td></tr>{{/if}}</tbody></table></div>{{/if}}{{if  $xml->getItem("/shop/page/remarks")}}
<div class="returns_details_wrapper">
<h2 class="big_label">{{$txt['69381::00_007']}}
                        </h2>
<div class="returns_details_w_sub">{{$xml->getItem("/shop/page/remarks")}}</div></div>{{/if}}{{if  $xml->getItem("/shop/page/pickup/name")}}
<div class="returns_details_wrapper">
<h2 class="big_label">{{$txt['69381::00_008']}}</h2>
...
<a target="_blank" data-tablet-class="btn-small" data-mobile-class="btn-small" title="{{$txt['69381::00_009']}}" href=" {{$xml->getItemEscape("/shop/page/pickup/link")}} ">
                                            {{$txt['69381::00_009']}}
                                        </a></div>
<div class="pickupl_return_one_header">
<span class="pickupl_return_one_name">{{$xml->getItemEscape("/shop/page/pickup/name")}}</span></div>
...
<span class="pickupl_return_one_city">{{$xml->getItemEscape("/shop/page/pickup/zipcode")}}{{$xml->getItemEscape("/shop/page/pickup/city")}}</span></div>
<div class="pickupl_return_one_info"></div></div></div></div></div>{{/if}}{{capture name="txt_54116_1" assign="txt_54116_1"}}{{$txt['69381::54116_1']}}{{/capture}}{{if $txt_54116_1 and count( $xml->getList("page/documents/document"))  gt (string) 0}}
<div class="returns_details_wrapper">
<div class="big_label">{{$txt_54116_1}}</div>
<div class="n55542_main_outline">
<div class="n55542_main">
<ul class="n54116_list">{{foreach from=$xml->getList("page/documents/document") item=loop770}}
<li class="n54116_item">
<a class="n54116_item" target="_blank" title="{{$txt['69381::54116_2']}}" href="{{$loop770->getItemEscape("@link")}}">{{$loop770->getItemEscape("@id")}}</a></li>{{/foreach}}</ul></div></div></div>{{/if}}</div>{{/if}}
...
<div{{assign "classAttributeTmp5" ""}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}basketedit_summary_left{{/capture}}{{capture name="classAttributeTmp5" assign="classAttributeTmp5"}}basketedit_summary_left{{$txt['69381::n55363_class2']}}{{/capture}}  class="{{$classAttributeTmp5}}"></div>
...
<div class="basketedit_calculations">{{if  $xml->getItem("/shop/page/costs/cost[@type='products']/@value_formatted")}}
<div class="basketedit_product_summary">
<label>{{$txt['69381::prepaid008w']}}
                                    </label>
<strong>{{$xml->getItemEscape("/shop/page/costs/cost[@type='products']/@value_formatted")}}</strong></div>{{/if}}{{if  $xml->getItem("/shop/page/costs/cost[@type='shipping']/@value_formatted")}}
<div class="basketedit_product_summary">
<label>{{$txt['69381::prepaid011do']}}
                                    </label>
<strong id="additional_cost_prepaid">{{$xml->getItemEscape("/shop/page/costs/cost[@type='shipping']/@value_formatted")}}</strong></div>{{/if}}{{if  $xml->getItem("/shop/page/costs/cost[@type='shop_shipping']/@value_formatted")}}
<div class="basketedit_product_summary">
<label>{{$txt['69381::prepaid011do2']}}
                                    </label>
<strong id="additional_cost_prepaid">{{$xml->getItemEscape("/shop/page/costs/cost[@type='shop_shipping']/@value_formatted")}}</strong></div>{{/if}}
<div style="clear:both"></div></div>{{if  $xml->getItem("/shop/page/costs/@value_formatted")}}
<div class="basketedit_total_summary">
<label>
                                    {{$txt['69381::prepaid011']}}
                                </label>
<strong id="currencytotal_prepaid">{{$xml->getItemEscape("/shop/page/costs/@value_formatted")}}</strong></div>{{/if}}</div></div></div></div>{{if  $xml->getItem("/shop/page/details/@status") == (string)1}}
<div class="prepaid_summary_buttons">{{if  $xml->getItem("page/backlink/@url")}}
<a class="btn" href="{{$xml->getItemEscape("page/backlink/@url")}}">
                        {{$txt['69381::order2_button_back']}}
                    </a>{{/if}}{{if  $xml->getItem("page/backlink_other/@url")}}
<a class="btn" href="{{$xml->getItemEscape("page/backlink_other/@url")}}">
                        {{$txt['69381::order2_button_back_other']}}
                    </a>{{/if}}</div>{{/if}}
<div id="menu_notice" style="display: none;">
<h2>{{$txt['69381::00_010']}}</h2>
<strong>
                {{$txt['69381::00_011']}}
            </strong>
<div class="menu_notice_button">
<button onclick="$('#dialog_close').click();" class="prepaid_cancel btn-small">
                    {{$txt['69381::00_012']}}
                </button>
<button class="prepaid_confirm btn-small">
                    {{$txt['69381::00_013']}}
                </button></div>
