...
<!--Navigation - elementy nawigacji (navigation_elements, 72760.1)-->
{{capture name="setLink_navigation" assign="setLink_navigation"}}{{$txt['72760::69967_setLink']}}{{/capture}}{{capture name="setNumber_navigation" assign="setNumber_navigation"}}{{$txt['72760::69967_setNumber']}}{{/capture}}
<div class="n69967_main">
<div class="n69967_description">
<h1 class="big_label">{{$xml->getItemEscape("page/description/name/text()")}}</h1>{{if  $xml->getItem("page/description/icon")}}
<img src="{{$xml->getItemEscape("page/description/icon")}}" alt="{{$xml->getItemEscape("page/description/@name")}}" title="{{$xml->getItemEscape("page/description/@name")}}"></img>{{/if}}
<div class="n69967_desc">{{$xml->getItem("page/description/desc")}}</div></div>
<div class="n69967_items">{{foreach from=$xml->getList("page/navigation/item") item=loop278}}
<a class="n69967" href="{{$loop278->getItemEscape("@link")}}">{{if  $loop278->getItem("@gfx")}}
<img src="{{$loop278->getItemEscape("@gfx")}}" alt="{{$loop278->getItemEscape("@name")}}" title="{{$loop278->getItemEscape("@name")}}"></img>{{/if}}
<span class="name">{{$loop278->getItemEscape("@name")}}</span>{{if $setNumber_navigation}}
<span class="count">
                                    {{$txt['72760::n69967_002']}}
<span>{{$loop278->getItemEscape("@product_quantity")}}</span>{{$txt['72760::n69967_002a']}}
                                </span>{{/if}}</a>{{/foreach}}</div>{{if $setLink_navigation and  $xml->getItem("/shop//item[@ni=/shop/navigation/current/@ni]/@display_all_link")}}
<a class="see_all btn-small" href=" {{$xml->getItemEscape("/shop//item[@ni=/shop/navigation/current/@ni]/@display_all_link")}} ">                             
                        {{$txt['72760::n69967_001']}}                        
                    </a>{{/if}}</div></div></div>
