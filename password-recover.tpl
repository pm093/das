...
<!--Formularz przypomnienia hasła (password-recover, 67952.1)-->

<div class="n67952_outline">
<div class="n67952_main">
<div class="signin-form_box_sub" id="signin-form_box_sub_recover">
<h1 class="big_label">
                {{$txt['67952::56478_007rec']}}
            </h1>
<p class="reminder_desc">{{$txt['67952::51100_001']}}</p>
<div class="signin-form_select">
<h3>{{$txt['67952::56478_007login']}}</h3>
<input id="signin-form_radio3" type="radio" value="signin-form_box_sub_1" name="login_form2"/>
<label for="signin-form_radio3">{{$txt['67952::56478_007l1']}}</label>
<input id="signin-form_radio4" type="radio" value="signin-form_box_sub_2" name="email_form2" checked="checked"/>
<label for="signin-form_radio4">{{$txt['67952::56478_007l2']}}</label></div>
...
<div class="signin_inputs" id="signin_inputs_recover">
<label class="reminder_label_signin">{{$txt['67952::51100_007']}}</label>
<input id="signin_pass_recover_input" type="text" name="email"/>
<button{{assign "classAttributeTmp3" ""}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}signin_password-recover{{/capture}} type="submit"{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}btn-small signin_password-recover{{/capture}}  class="{{$classAttributeTmp3}}">
                     {{$txt['67952::51100_003']}}
                </button></div></form>
<div class="n67952_phone">
<div class="n67952_phone_sub">
<span class="n67952_infotext_label">
                {{$txt['67952::51100_004']}}
<b>{{literal}} {{/literal}}{{$xml->getItemEscape("page/login/response/@tel")}}</b>{{literal}} {{/literal}}{{$txt['67952::51100_005']}}{{literal}} {{/literal}}
<a class="mail_54144" href="mailto:{{$xml->getItemEscape("page/login/response/@email")}}">{{$xml->getItemEscape("page/login/response/@email")}}</a>.</span></div></div></div></div></div>{{if  $xml->getItem("/shop/page/password-recover")}}{{/if}}</div></div>
