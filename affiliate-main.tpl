...
<!--Strona główna programu partnerskiego - CMS (affiliate_main_cms, 59247.1)-->
{{if !( $xml->getItem("page/@type") == (string)'affiliate-not-active')}}
<div class="affiliate_main_cms_label">
<span{{assign "classAttributeTmp3" ""}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}affiliate_main_cms_label{{/capture}}{{capture name="classAttributeTmp3" assign="classAttributeTmp3"}}big_label affiliate_main_cms_label{{/capture}}  class="{{$classAttributeTmp3}}">
                {{$txt['59247::affiliate_main_cms_label']}}
            </span></div>{{if  $xml->getItem("page/text/body")}}
<div class="affiliate_main_cms">
<div{{assign "classAttributeTmp4" ""}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}affiliate_main_cms_sub{{/capture}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}affiliate_main_cms_sub cm{{/capture}}  class="{{$classAttributeTmp4}}">{{$xml->getItem("page/text/body")}}</div></div>{{/if}}{{/if}}</div></div>
