...
<div{{assign "classAttributeTmp4" ""}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}order2_info_label{{/capture}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}big_label order2_info_label{{/capture}}  class="{{$classAttributeTmp4}}">
                        {{$txt['69374::54568_001ca']}}
                </div>
<div class="order2_info">
<div class="order2_info_sub" id="order2_info_sub1">
<h3 class="order2_info1" id="order2_nagl_1">
                            {{$txt['69374::51000_info1ba']}}
                        </h3>
<div class="order2_info1" id="order2_box_1">
<div class="order2_info1_sub">{{if  $xml->getItem("page/orderclient/@firm")}}{{$xml->getItemEscape("page/orderclient/@firm")}}
<br/>{{/if}}{{if !( $xml->getItem("page/orderclient/@firm"))}}{{$xml->getItemEscape("page/orderclient/@firstname")}}{{literal}} {{/literal}}{{$xml->getItemEscape("page/orderclient/@lastname")}}
<br/>{{/if}}{{$xml->getItemEscape("page/orderclient/@street")}}
...
<br/>{{if  $xml->getItem("page/orderclient/@nip")}}
                                    {{$txt['69374::51000_infonip']}}{{$xml->getItemEscape("page/orderclient/@nip")}}
<br/>{{/if}}
                                {{$txt['69374::40009_010']}}
                                {{$xml->getItemEscape("page/orderclient/@email")}}
<br/></div>
<a class="order2_button_change" href="{{$xml->getItemEscape("page/orderclient/@changelink")}}">
                                {{$txt['69374::51000_900a']}}
                            </a></div></div>
<div class="order2_info_sub" id="order2_info_sub2">{{if  $xml->getItem("page/pickup")}}
<h3 class="order2_info1" id="order2_nagl_2a">
                                    {{$txt['69374::51000_info2a']}}
                                </h3>
...
<a class="order2_stock_moreinfo" href="{{$xml->getItemEscape("page/pickup/link")}}">
                                                {{$txt['69374::order2_stock_link']}}
                                            </a></div></div>
<a class="order2_button_change_stock" target="_blank" href="{{$xml->getItemEscape("page/pickupchangelink/@url")}}">
                                        {{$txt['69374::order2_change_stock_link']}}
                                    </a></div>{{else}}
<h3 class="order2_info1" id="order2_nagl_2b">
                                    {{$txt['69374::51000_info2bc']}}
                                </h3>
<div class="order2_info1" id="order2_box_2b">
<div class="order2_info1_sub">{{if  $xml->getItem("page/deliveryaddress/@additional")}}{{$xml->getItemEscape("page/deliveryaddress/@additional")}}
<br/>{{/if}}{{$xml->getItemEscape("page/deliveryaddress/@street")}}
...
<br/></div>
<a class="order2_button_change_address" href="{{$xml->getItemEscape("page/deliveryaddress/@changelink")}}">
                                        {{$txt['69374::51000_900']}}
                                    </a></div>{{/if}}</div>{{if  $xml->getItem("/shop/page/remarks")}}
<div class="order2_info_sub">
<h3 class="order2_info1">
                                {{$txt['69374::order2_comment1']}}
                            </h3>
<div class="order2_info1" id="order2_box_1">
<div class="order2_info1_sub">{{$xml->getItem("/shop/page/remarks")}}</div></div></div>{{/if}}</div>
<div class="order2_products">{{capture name="return_with_special_offer" assign="return_with_special_offer"}}{{$txt['69374::57649_return_with_special_offer']}}{{/capture}}{{capture name="required_from_special_offer" assign="required_from_special_offer"}}{{$txt['69374::57649_required_from_special_offer']}}{{/capture}}{{if $return_with_special_offer  neq (string) '' and  $xml->getItem("/shop/page/returnproducts/products/@return_with_special_offer")  == (string) 'true'}}
...
<div>{{$return_with_special_offer}}</div></div>{{/if}}
<table class="order2_table">
<tr>
<th class="order2_name">
                        {{$txt['69374::51000b']}}
                        </th>{{if  $xml->getItem("/shop/page/returnproducts/products/product/@required_from_special_offer")  == (string) 'true' and $required_from_special_offer  neq (string) ''}}
<th class="order2_special_offer">
                                {{$txt['69374::51000_1thorder2_special_offer']}}
                            </th>{{/if}}
...
<th class="order2_worth">
                        {{$txt['69374::51000_3']}}
                        </th></tr>{{foreach from=$xml->getList("page/returnproducts/products/product") item=loop500}}
<tr>
<td class="order2_name">{{if  $loop500->getItem("@gratis") == (string)'y'}}
<span class="order2_name">{{$loop500->getItem("@name")}}</span>{{else}}
<a class="order2_name" href="{{$loop500->getItemEscape("@link")}}">{{$loop500->getItem("@name")}}</a>{{/if}}{{if !( $loop500->getItem("size/@type") == (string)'uniw')}}
<div class="order2_size_desc">
                                    {{$txt['69374::51000_013']}}
                                    {{$loop500->getItemEscape("size/@description")}}</div>{{/if}}{{if ( $loop500->getItem("version")) and (!( $loop500->getItem("version/@product_name") == (string)''))}}
<div class="order2_size_desc">{{$loop500->getItemEscape("version/@name")}}{{$txt['69374::51000_0kro']}}{{$loop500->getItemEscape("version/@product_name")}}</div>{{/if}}{{if  $loop500->getItem("@required_from_special_offer")  == (string) 'true' and $required_from_special_offer  neq (string) ''}}{{if  $loop500->getItem("@required_from_special_offer")  == (string) 'true'}}
<div{{assign "classAttributeTmp6" ""}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}productslist_product_special_offer{{/capture}}{{capture name="classAttributeTmp6" assign="classAttributeTmp6"}}productslist_product_info visible-phone{{/capture}}  class="{{$classAttributeTmp6}}">
                                    {{$txt['69374::57649_required_from_special_offer']}}
                                  </div>{{/if}}{{/if}}</td>{{if  $loop500->getItem("@required_from_special_offer")  == (string) 'true' and $required_from_special_offer  neq (string) ''}}
<td{{assign "classAttributeTmp7" ""}}{{capture name="classAttributeTmp7" assign="classAttributeTmp7"}}productslist_product_special_offer{{/capture}}{{capture name="classAttributeTmp7" assign="classAttributeTmp7"}}productslist_product_special_offer hidden-phone{{/capture}}  class="{{$classAttributeTmp7}}">{{if  $loop500->getItem("@required_from_special_offer")  == (string) 'true'}}
<div class="productslist_product_special_offer">
                                    {{$txt['69374::57649_required_from_special_offer']}}
                                  </div>{{/if}}</td>{{/if}}
<td class="order2_price">{{if  $loop500->getItem("@forpoints")}}{{$loop500->getItemEscape("@points_for_one")}}{{$txt['69374::51000_993']}}
                            {{/if}}{{if !( $loop500->getItem("@forpoints"))}}{{$loop500->getItemEscape("@detalprice_formatted")}}{{/if}}</td>
<td class="order2_quantity">{{$loop500->getItemEscape("@quantity")}}{{literal}} {{/literal}}{{$loop500->getItemEscape("@worth_unit")}}</td>
<td class="order2_bruttoworth">{{if  $loop500->getItem("@gratis") == (string)'y'}}
                                    {{$txt['69374::51000_gratis']}}
                                {{elseif !( $loop500->getItem("@forpoints"))}}{{$loop500->getItemEscape("@bruttoworth_formatted")}}{{elseif  $loop500->getItem("@forpoints")}}{{$loop500->getItemEscape("@points")}} 
                                    {{$txt['69374::51000_993']}}
                                {{/if}}</td></tr>{{/foreach}}</table></div>
<div class="order2_products">
<table class="order2_table">
<tr>
<th class="order2_name">
                        {{$txt['69374::deliv51066abis']}}
                        </th>
<th class="order2_worth"></th></tr>{{if  $xml->getItem("/shop/page/return_method")}}
<tr>
<td class="order2_name">{{if  $xml->getItem("/shop/page/return_method/@description")}}
<span class="order2_name">{{$txt['69374::order2_info_21a']}}
                                                     {{$xml->getItemEscape("/shop/page/return_method/@name")}}</span>
<div class="return_description">{{$xml->getItemEscape("/shop/page/return_method/@description")}}</div>{{elseif  $xml->getItem("/shop/page/return_method/@id")  == (string) 1}}
<span class="order2_name">{{$txt['69374::order2_info_21a']}}
                                                    {{$txt['69374::51900_1_bis']}}
                                                </span>
<div class="return_description">
                                                    {{$txt['69374::51900_1_d_bis']}}
                                                </div>{{elseif  $xml->getItem("/shop/page/return_method/@id")  == (string) 2}}
<span class="order2_name">
                                                    {{$txt['69374::order2_info_21a']}}
                                                    {{$txt['69374::51900_2_bis']}}
                                                </span>
<div class="return_description">
                                                    {{$txt['69374::51900_2_d_bis']}}
                                                </div>{{elseif  $xml->getItem("/shop/page/return_method/@id")  == (string) 3}}
<span class="order2_name">
                                                    {{$txt['69374::order2_info_21a']}}
                                                    {{$txt['69374::51900_3_bis']}}
                                                </span>
<div class="return_description">
                                                    {{$txt['69374::51900_3_d_bis']}}
                                                </div>{{/if}}</td>
<td class="order2_bruttoworth">
<div class="worth_box">{{if  $xml->getItem("/shop/page/costs/cost[@type='shop_shipping']")}}{{$xml->getItemEscape("/shop/page/costs/cost[@type='shop_shipping']/@value_formatted")}}{{/if}}</div></td></tr>{{/if}}
<tr>
<td class="order2_name">{{if  $xml->getItem("/shop/page/repayment_method/@id")  == (string) 't'}}
...
<div class="return_description">{{$xml->getItemEscape("/shop/page/repayment_method/@description")}}</div>{{/if}}</td>
<td class="order2_bruttoworth"></td></tr></table></div>
<div class="basketedit_summary">
<div class="basketedit_summary_sub">
<div class="basketedit_summary_left"></div>
...
<div class="basketedit_product_summary">
<label>
                                            {{$txt['69374::prepaid011do']}}
                                        </label>
<strong>{{$xml->getItemEscape("/shop/page/costs/cost[@type='shipping']/@value_formatted")}}</strong></div>{{/if}}{{if  $xml->getItem("/shop/page/costs/cost[@type='shop_shipping']/@value_formatted")}}
<div class="basketedit_product_summary">
<label>
                                                {{$txt['69374::prepaid011do2']}}
                                            </label>
<strong class="paymentcost_value">{{$xml->getItemEscape("/shop/page/costs/cost[@type='shop_shipping']/@value_formatted")}}</strong></div>{{/if}}
<div style="clear:both"></div></div>{{if  $xml->getItem("/shop/page/costs/@value_formatted")}}
<div class="basketedit_total_summary">
<label>
                                        {{$txt['69374::53706_001c']}}
                                    </label>
<strong>{{$xml->getItemEscape("/shop/page/costs/@value_formatted")}}</strong></div>{{/if}}</div>
...
<a class="btn" href="{{$xml->getItemEscape("page/backlink/@url")}}">
                                        {{$txt['69374::order2_button_back']}}
                                    </a>{{/if}}</div>
<div class="btn_wrapper">
<input{{assign "valueAttributeTmp8" ""}}  class="btn-large" type="submit"{{capture name="valueAttributeTmp8" assign="valueAttributeTmp8"}}{{$txt['69374::order2_button_order']}}{{/capture}}{{if $xml->getItem("/shop/return_edit/@return_id")}}{{capture name="valueAttributeTmp8" assign="valueAttributeTmp8"}}{{$txt['69374::order2_button_order_ch']}}{{/capture}}{{/if}}  value="{{$valueAttributeTmp8}}"></input></div></div></div></div></form></div></div>{{/if}}
