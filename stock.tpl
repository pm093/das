...
<script type="text/javascript" src="/gfx/{{$xml->getItemEscape("language/@id")}}/stock_info.js.gzip?r=1551959302"></script></head>{{capture name="meta_body_id" assign="meta_body_id"}}{{$txt['96599::10001_body_id']}}{{/capture}}{{literal}}
...
<span class="stock_cms_label">
                    {{$txt['58112::stock_cms_label']}}
            </span></div>
<div class="stock_cms">
<div class="stock_cms_sub">{{$xml->getItem("page/text/body")}}</div></div>{{/if}}
<!--Informacja o magazynie (stock_info, 64867.9)-->
{{capture name="mapType" assign="mapType"}}{{$txt['64867::64553_MAPA_001']}}{{/capture}}{{capture name="navControl" assign="navControl"}}{{$txt['64867::64553_MAPA_002']}}{{/capture}}{{capture name="mapTypeControl" assign="mapTypeControl"}}{{$txt['64867::64553_MAPA_003']}}{{/capture}}{{capture name="scControl" assign="scControl"}}{{$txt['64867::64553_MAPA_004']}}{{/capture}}{{capture name="controlType" assign="controlType"}}{{$txt['64867::64553_MAPA_005']}}{{/capture}}{{capture name="mapTypeControlStyle" assign="mapTypeControlStyle"}}{{$txt['64867::64553_MAPA_006']}}{{/capture}}{{capture name="mapHide" assign="mapHide"}}{{$txt['64867::64553_MAPA_013']}}{{/capture}}{{capture name="markersAnimation" assign="markersAnimation"}}{{$txt['64867::64553_MAPA_007']}}{{/capture}}{{capture name="bCord" assign="bCord"}}{{$txt['64867::64553_MAPA_008']}}{{/capture}}{{capture name="lCord" assign="lCord"}}{{$txt['64867::64553_MAPA_009']}}{{/capture}}{{capture name="mapZoom" assign="mapZoom"}}{{$txt['64867::64553_MAPA_010']}}{{/capture}}{{capture name="mapLanguage" assign="mapLanguage"}}{{$txt['64867::64553_MAPA_011']}}{{/capture}}{{capture name="mapCustomMarkers" assign="mapCustomMarkers"}}{{$txt['64867::64553_MAPA_012']}}{{/capture}}
<script>
...
<span class="stock_label">
                    {{$txt['64867::stock_info_label']}}
                </span></div>
<div class="stock_info_sub">
<div class="stock_info_details">{{if  $xml->getItem("page/stock/@name") and ( $xml->getItem("page/stock/@name")  neq (string) '')}}
<div class="stock_info_section" id="stock_info_details_name">
<span class="stock_info_title">{{$txt['64867::stock_info_name_title']}}</span>
<h1 class="stock_info_name">{{$xml->getItemEscape("page/stock/@name")}}</h1></div>{{/if}}{{if  $xml->getItem("page/stock/@street") and ( $xml->getItem("page/stock/@street")  neq (string) '')}}
...
<span class="stock_info_value">{{$xml->getItemEscape("page/stock/@street")}}</span></div>{{/if}}{{if  $xml->getItem("page/stock/@zipcode") and ( $xml->getItem("page/stock/@zipcode")  neq (string) '')}}
...
<span class="stock_info_value">{{$xml->getItemEscape("page/stock/@zipcode")}}</span></div>{{/if}}{{if  $xml->getItem("page/stock/@city") and ( $xml->getItem("page/stock/@city")  neq (string) '')}}
<div class="stock_info_section" id="stock_info_details_city">
<span class="stock_info_title">{{$txt['64867::stock_info_city_title']}}</span>
<span class="stock_info_value">{{$xml->getItemEscape("page/stock/@city")}}</span></div>{{/if}}{{if  $xml->getItem("page/stock/@country") and ( $xml->getItem("page/stock/@country")  neq (string) '')}}
...
<span class="stock_info_value">{{$xml->getItemEscape("page/stock/@country")}}</span></div>{{/if}}{{if  $xml->getItem("page/stock/@phone") and ( $xml->getItem("page/stock/@phone")  neq (string) '')}}
...
<span class="stock_info_value">{{if  $xml->getItem("page/stock/@phone_link") and ( $xml->getItem("page/stock/@phone_link")  neq (string) '')}}
<a href="{{$xml->getItemEscape("page/stock/@phone_link")}}" title="{{$xml->getItemEscape("page/stock/@phone")}}">{{$xml->getItemEscape("page/stock/@phone")}}</a>{{else}}{{$xml->getItemEscape("page/stock/@phone")}}{{/if}}</span></div>{{/if}}{{if  $xml->getItem("page/stock/@fax") and ( $xml->getItem("page/stock/@fax")  neq (string) '')}}
<div class="stock_info_section" id="stock_info_details_fax">
<span class="stock_info_title">{{$txt['64867::stock_info_fax_title']}}</span>
<span class="stock_info_value">{{$xml->getItemEscape("page/stock/@fax")}}</span></div>{{/if}}{{if  $xml->getItem("page/stock/@mail") and ( $xml->getItem("page/stock/@mail")  neq (string) '')}}
<div class="stock_info_section" id="stock_info_details_mail">
<span class="stock_info_title">{{$txt['64867::stock_info_mail_title']}}</span>
<a{{assign "hrefAttributeTmp8" ""}}  class="stock_info_value" title="{{$xml->getItemEscape("page/stock/@mail")}}" {{if $xml->getItem("page/stock/@mail_link") and $xml->getItem("page/stock/@mail_link") neq (string) ''}}{{capture name="hrefAttributeTmp8" assign="hrefAttributeTmp8"}}{{$xml->getItemEscape("page/stock/@mail_link")}}{{/capture}}{{else}}{{capture name="hrefAttributeTmp8" assign="hrefAttributeTmp8"}}mailto:{{$xml->getItemEscape("page/stock/@mail")}}{{/capture}}{{/if}}  href="{{$hrefAttributeTmp8}}">{{$xml->getItemEscape("page/stock/@mail")}}</a></div>{{/if}}{{if  $xml->getItem("page/stock/@gg") and ( $xml->getItem("page/stock/@gg")  neq (string) '')}}
...
<img alt="gg" src="http://status.gadu-gadu.pl/users/status.asp?id={{$xml->getItemEscape("page/stock/@gg")}}"></img>{{$xml->getItemEscape("page/stock/@gg")}}</a></div>{{/if}}{{if  $xml->getItem("page/stock/@skype") and ( $xml->getItem("page/stock/@skype")  neq (string) '')}}
...
<img alt="skype" src="http://mystatus.skype.com/smallicon/{{$xml->getItemEscape("page/stock/@skype")}}"></img>{{$xml->getItemEscape("page/stock/@skype")}}</a></div>{{/if}}{{if  $xml->getItem("page/stock/@street") and ( $xml->getItem("page/stock/@street")  neq (string) '') or  $xml->getItem("page/stock/@zipcode") or ( $xml->getItem("page/stock/@zipcode")  neq (string) '') or  $xml->getItem("page/stock/@city") and ( $xml->getItem("page/stock/@city")  neq (string) '')}}{{if ($mapHide  neq (string) '') and  $xml->getItem("page/stock/google_api_key/@value")}}
...
<span class="stock_info_hours_label">{{$txt['64867::stock_info_hours_label']}}</span>{{if  $xml->getItem("page/stock_time/monday")}}
<div class="stock_info_hours_day">
<span class="stock_info_hours_day">{{$txt['64867::stock_info_hours_monday']}}</span>
<span class="stock_info_hours_time">{{if  $xml->getItem("page/stock_time/monday/@open")  neq (string)  $xml->getItem("page/stock_time/monday/@close")}}
                                        {{$txt['64867::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/monday/@open")}}{{$txt['64867::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/monday/@close")}}{{else}}
                                        {{$txt['64867::stock_info_hours_inactive']}}
                                    {{/if}}</span></div>{{/if}}{{if  $xml->getItem("page/stock_time/tuesday")}}
<div class="stock_info_hours_day">
<span class="stock_info_hours_day">{{$txt['64867::stock_info_hours_tuesday']}}</span>
<span class="stock_info_hours_time">{{if  $xml->getItem("page/stock_time/tuesday/@open")  neq (string)  $xml->getItem("page/stock_time/tuesday/@close")}}
                                        {{$txt['64867::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/tuesday/@open")}}{{$txt['64867::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/tuesday/@close")}}{{else}}
                                        {{$txt['64867::stock_info_hours_inactive']}}
                                    {{/if}}</span></div>{{/if}}{{if  $xml->getItem("page/stock_time/wednesday")}}
<div class="stock_info_hours_day">
<span class="stock_info_hours_day">{{$txt['64867::stock_info_hours_wednesday']}}</span>
<span class="stock_info_hours_time">{{if  $xml->getItem("page/stock_time/wednesday/@open")  neq (string)  $xml->getItem("page/stock_time/wednesday/@close")}}
                                        {{$txt['64867::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/wednesday/@open")}}{{$txt['64867::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/wednesday/@close")}}{{else}}
                                        {{$txt['64867::stock_info_hours_inactive']}}
                                    {{/if}}</span></div>{{/if}}{{if  $xml->getItem("page/stock_time/thursday")}}
<div class="stock_info_hours_day">
<span class="stock_info_hours_day">{{$txt['64867::stock_info_hours_thursday']}}</span>
<span class="stock_info_hours_time">{{if  $xml->getItem("page/stock_time/thursday/@open")  neq (string)  $xml->getItem("page/stock_time/thursday/@close")}}
                                        {{$txt['64867::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/thursday/@open")}}{{$txt['64867::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/thursday/@close")}}{{else}}
                                        {{$txt['64867::stock_info_hours_inactive']}}
                                    {{/if}}</span></div>{{/if}}{{if  $xml->getItem("page/stock_time/friday")}}
<div class="stock_info_hours_day">
<span class="stock_info_hours_day">{{$txt['64867::stock_info_hours_friday']}}</span>
<span class="stock_info_hours_time">{{if  $xml->getItem("page/stock_time/friday/@open")  neq (string)  $xml->getItem("page/stock_time/friday/@close")}}
                                        {{$txt['64867::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/friday/@open")}}{{$txt['64867::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/friday/@close")}}{{else}}
                                        {{$txt['64867::stock_info_hours_inactive']}}
                                    {{/if}}</span></div>{{/if}}{{if  $xml->getItem("page/stock_time/saturday")}}
<div class="stock_info_hours_day">
<span class="stock_info_hours_day">{{$txt['64867::stock_info_hours_saturday']}}</span>
<span class="stock_info_hours_time">{{if  $xml->getItem("page/stock_time/saturday/@open")  neq (string)  $xml->getItem("page/stock_time/saturday/@close")}}
                                        {{$txt['64867::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/saturday/@open")}}{{$txt['64867::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/saturday/@close")}}{{else}}
                                        {{$txt['64867::stock_info_hours_inactive']}}
                                    {{/if}}</span></div>{{/if}}{{if  $xml->getItem("page/stock_time/sunday")}}
<div class="stock_info_hours_day">
<span class="stock_info_hours_day">{{$txt['64867::stock_info_hours_sunday']}}</span>
<span class="stock_info_hours_time">{{if  $xml->getItem("page/stock_time/sunday/@open")  neq (string)  $xml->getItem("page/stock_time/sunday/@close")}}
                                        {{$txt['64867::stock_info_hours_open']}}{{$xml->getItemEscape("page/stock_time/sunday/@open")}}{{$txt['64867::stock_info_hours_close']}}{{$xml->getItemEscape("page/stock_time/sunday/@close")}}{{else}}
                                        {{$txt['64867::stock_info_hours_inactive']}}
                                    {{/if}}</span></div>{{/if}}</div></div>{{if  $xml->getItem("page/stock/google_api_key/@value") and ( $xml->getItem("page/stock/@street") and ( $xml->getItem("page/stock/@street")  neq (string) '') or  $xml->getItem("page/stock/@zipcode") and ( $xml->getItem("page/stock/@zipcode")  neq (string) '') or  $xml->getItem("page/stock/@city") and ( $xml->getItem("page/stock/@city")  neq (string) ''))}}
...
<div id="stock_map" class="stock_map_wrapper"></div></div>{{/if}}
<div class="stock_info_subborder" style="display: none;"></div>{{if  $xml->getItem("page/stock/text()")}}
<div{{assign "classAttributeTmp4" ""}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}stock_label{{/capture}}{{capture name="classAttributeTmp4" assign="classAttributeTmp4"}}big_label stock_label{{/capture}}  class="{{$classAttributeTmp4}}">
<span class="stock_label">
                        {{$txt['64867::stock_info_label2']}}
                    </span></div>
<div class="stock_info_desc">{{$xml->getItem("page/stock")}}</div>{{/if}}</div></div></div>
