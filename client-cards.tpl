...
<!--Karty stałego klienta - cms (client_cards_cms, 61880.1)-->
{{if  $xml->getItem("page/text/body")}}
<div class="client-cards_cms">
<div class="client-cards_cms_sub">{{$xml->getItem("page/text/body")}}</div></div>{{/if}}
<!--Karty stałego klienta - informacje (client_cards_info, 61881.1)-->
...
<table>
<tr>
<th>{{$txt['61881::61881_2']}}</th>
<th>{{$txt['61881::61881_3']}}</th>
<th>{{$txt['61881::61881_4']}}</th>
<th>{{$txt['61881::61881_5']}}</th></tr>{{foreach from=$xml->getList("/shop/page/cards/item") item=loop293}}
<tr>
<td class="client_cards_expires">{{$loop293->getItemEscape("@expires")}}</td>
<td class="client_cards_name">{{$loop293->getItemEscape("@name")}}</td>
<td class="client_cards_number">{{$loop293->getItemEscape("@number")}}</td>
<td class="client_cards_active">{{if  $loop293->getItem("@active")  == (string) 'y'}}          
			{{$txt['61881::61881_6']}}
                {{elseif  $loop293->getItem("@active")  == (string) 'n'}}          
			{{$txt['61881::61881_7']}}
                {{else}}
                     {{$txt['61881::61881_8']}}
                {{/if}}</td></tr>{{/foreach}}</table>
<p>
         {{$txt['61881::61881_9']}}
	 
<a href="client-rebate.php">{{$txt['61881::61881_10']}}</a></p></div>{{/if}}</div></div>
