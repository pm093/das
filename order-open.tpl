...
<!--Otwórz zamówienie (order_open_form, 68516.1)-->
{{capture name="required_68516" assign="required_68516"}}{{$txt['68516::68516_required']}}{{/capture}}
<div class="order_open_form_wrapper">
<h1 class="big_label">
            {{$txt['68516::54176_004s']}}
        </h1>
<p>{{$txt['68516::54176_002de']}}</p>
<form action="order-open.php" method="post" class="order_open_form">
<input type="hidden" name="operation" value="order_open"/>
<div class="order_open_form">
<label>{{$txt['68516::54176_003']}}</label>
<input type="text" name="order_id"/>{{if $required_68516}}
<img src="/gfx/__IAI_TEMPLATE_LANG_639_1__/need.gif?r=1551959302" alt="{{$txt['68516::n56203_010b']}}" title="{{$txt['68516::n56203_010b']}}"></img>{{/if}}</div>
<div class="order_open_form">
<label>{{$txt['68516::54176_002']}}</label>
<input class="order-open1" type="text" name="email"/>{{if $required_68516}}
<img src="/gfx/__IAI_TEMPLATE_LANG_639_1__/need.gif?r=1551959302" alt="{{$txt['68516::n56203_010b']}}" title="{{$txt['68516::n56203_010b']}}"></img>{{/if}}</div>
...
<div class="order_open_required">
                        {{$txt['68516::68516_003']}}
<img src="/gfx/__IAI_TEMPLATE_LANG_639_1__/need.gif?r=1551959302" alt="{{$txt['68516::n56203_010b']}}" title="{{$txt['68516::n56203_010b']}}"></img>{{$required_68516}}</div>{{/if}}</form>
<a href="/login.php">{{$txt['68516::54176_004lo']}}</a></div></div></div>
